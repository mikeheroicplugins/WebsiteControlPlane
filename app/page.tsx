    ...
    <section className="modal lovable-launch-modal" role="dialog" aria-modal="true" aria-labelledby="lovable-launch-title">
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="form-grid">
          ...
          <label>Branch<input name="repositoryBranch" placeholder="Auto-detect default branch" /><small>Leave blank to use the repository’s current default branch.</small></label>
